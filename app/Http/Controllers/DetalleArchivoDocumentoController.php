...
class DetalleArchivoDocumentoController extends Controller
{
    ...
    public function show()
    {
        ...
        $documentos = DB::table('documentos')
            ...
            ->select('documentos.tipoDocumento_id', 'detalle_archivo_documentos.nombreArchivo', 'permisos.tipoPermiso_id', 'permisos.documento_id', 'detalle_permisos.departamento_id', 'detalle_permisos.colaborador_id')
